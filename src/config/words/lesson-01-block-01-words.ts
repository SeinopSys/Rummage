...
export const lesson01Block01Words: Word[] = [
  { native: 'семья', stressIndex: 4, key: "syem'ja", gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'бабушка', stressIndex: 1, key: 'babushka', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'дедушка', stressIndex: 1, key: 'dyedushka', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'мама', stressIndex: 1, key: 'mama', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'мать', key: "mat'", gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  ...
  { native: 'жена', stressIndex: 3, key: 'zhyena', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'сестра', stressIndex: 5, key: 'syestra', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'дочь', key: "dots'", gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'внук', key: 'vnuk', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
  { native: 'внучка', stressIndex: 2, key: 'vnutska', gender: Gender.MASCULINE, categories: [Category.FAMILY] },
